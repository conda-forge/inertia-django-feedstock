About inertia-django-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/inertia-django-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/inertia-django-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add inertia-django
# for installing globally
pixi global install inertia-django
```
...
It is possible to list all of the versions of `inertia-django` available on your platform:
...
```
pixi search inertia-django --channel conda-forge
```
